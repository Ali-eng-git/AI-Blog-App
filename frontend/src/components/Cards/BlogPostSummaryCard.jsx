...
import { LuEye, LuHeart, LuTrash2,LuGalleryVerticalEnd } from "react-icons/lu";
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2.5 mt-2 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 text-xs text-sky-700 font-medium bg-sky-50 px-2.5 py-1 rounded">
