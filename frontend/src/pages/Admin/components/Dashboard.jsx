...
const Dashboard = () => {
  ...
  return (
    <DashboardLayout activeMenu={"Dashboard"}>
      {dashboardData && (
        <>
          <div className="bg-white p-6 rounded-2xl shadow-md shadow-gray-100 border border-gray-200 mt-1.5">
            <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mt-5 mb-32">
